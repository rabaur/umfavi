...
def main(args):
    ...
    feature_module = MLPFeatureModule(obs_dim, act_dim, [64, 32])
    ...
    for epoch in range(args.num_epochs):
        ...
        if not args.no_wandb:
            # Compute EPIC distance and expected regret
            with torch.no_grad():
...
if __name__ == "__main__":
    ...
    parser.add_argument("--kl_weight", type=float, default=10.0, help="KL weight - use kl_restart_period for annealing")
