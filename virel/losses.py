...
def elbo_loss(log_likelihood: torch.Tensor, kl_divergence: torch.Tensor, kl_weight: float = 1.0) -> torch.Tensor:
    """
    Compute ELBO loss.
    
    Args:
        log_likelihood: Negative log likelihood of the model (already a loss)
